                  ...
                  {[1, 2, 3].map((num) => (
                    <li key={num}>
                      <button
                        ...
                        className={` w-full text-left py-3 px-6 font-medium rounded-2xl transition-all duration-200  flex justify-center ${
                          activeTab === num
              ...
              <div className=" p-2 md:col-span-5 ">
                <div className="flex-1  rounded-2xl p-6 shadow-md glass-card md:h-[95vh] h-[80vh]">
                  {activeTab === 1 && (
                    <div>
                      <p className="text-white-700">
                        This is the{" "}
                        <em className="font-semibold text-indigo-800">first</em>{" "}
                        tab content.
                      </p>
                      <Tab1 />
                    </div>
                  ...
                  {activeTab === 2 && (
                    <p className="text-white-700">
                      This is the{" "}
                      <em className="font-semibold text-indigo-800">second</em>{" "}
                      tab content.
                    </p>
                  )}
                  {activeTab === 3 && (
                    <p className="text-white-700">
                      This is the{" "}
                      <em className="font-semibold text-indigo-800">third</em>{" "}
                      tab content.
                    </p>
                  )}
                </div>
